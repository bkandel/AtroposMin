...
::AtroposSegmentationImageFilter()
{
  ...
  this->m_NumberOfTissueClasses = 1;
...
::GenerateData()
{
  ...
  this->m_MixtureModelComponents[0]->SetListSampleWeights( &weights );
  this->m_MixtureModelComponents[0]->SetInputListSample( sample );
  this->m_MixtureModelComponents[0]->ClearInputListSample();
}
